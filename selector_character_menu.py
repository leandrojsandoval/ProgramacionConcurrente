    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key in (pygame.K_DOWN, pygame.K_UP):
                ...
                current_selection = (current_selection + direction) % total_characters  # Movimiento circular
                ...
                if current_selection < first_visible_index:
                    ...
                    first_visible_index = current_selection - visible_characters_count + 1
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            for i, name in enumerate(characters_names[first_visible_index:first_visible_index + visible_characters_count]):

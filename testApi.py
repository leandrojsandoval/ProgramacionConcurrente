    ...
    for archivo in os.listdir('characters'):
        if archivo.endswith('.json'):
            with open(f'characters/{archivo}', 'r') as f:
                ...
                pokemons[pokemon.name.capitalize()] = pokemon  # Usar capitalize para asegurarse de que la clave esté en mayúscula
...
for nombre, pokemon in coleccion_pokemons.items():
    print(f"Nombre: {nombre}, Salud: {pokemon.health}, Ataque: {pokemon.attack_power}, Defensa: {pokemon.defense}")
